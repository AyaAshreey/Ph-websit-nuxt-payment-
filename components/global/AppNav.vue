...
<a @click="toggleDirection" class="Lang-btn" href="#">EN</a>
                    ...
                    <v-row class="darkgreen-nav mt-6 " style="width:100% ; background-color: var(--secNavColor) ;position: fixed;
    top: 92px;
    left: 12px;">
                        ...
                        <v-col cols="8">
                            <ul class="links d-flex text-white justify-space-between" style="list-style: none;">
                                <li>
                                    <NuxtLink to="/">{{ $t('secNav.all') }}</NuxtLink>
                                    <!-- <router-link @click="showAlert" to="/"> </router-link> -->
                                </li>
                                <li>
                                    <NuxtLink to="/PaymentResponse"> {{ $t('secNav.hairCare') }} </NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink to="/"> {{ $t('secNav.skinCare') }} </NuxtLink>
                                </li>
                                <li class="extra-link">
                                    <NuxtLink to="/"> {{ $t('secNav.MenCare') }} </NuxtLink>
                                </li>
                                <li class="extra-link">
                                    <NuxtLink to="/"> {{ $t('secNav.WomenCare') }} </NuxtLink>
                                </li>
                                <li class="extra-link">
                                    <NuxtLink to="/"> {{ $t('secNav.BabyCare') }} </NuxtLink>
                                </li>
                                <li class="extra-link">
                                    <NuxtLink to="/"> {{ $t('secNav.AnimalPharmacy') }}
                                    </NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink to="/"> {{ $t('secNav.Brands') }} </NuxtLink>
                                </li>
                                <li class="extra-link">
                                    <NuxtLink @click="showAlert" to="/"> {{ $t('secNav.Offers') }} </NuxtLink>
                                </li>
                            </ul>
                        </v-col>
